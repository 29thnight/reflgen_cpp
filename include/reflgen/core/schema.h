    ...
    namespace detail
    {
        ...
        consteval auto resolve_schema()
        {
            ...
            else if constexpr (has_external_reflection<T>)
            {
                ...
                static_assert(is_type_schema<result>::value,
                              "reflgen::reflection<T>::value must be reflgen::schema<T>(...)");
            ...
            else
            {
                static_assert(dependent_false<T>,
                              "T inherits reflect() from a base class but does not declare its own; "
