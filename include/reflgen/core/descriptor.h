...
struct field_descriptor
{
    ...
    consteval field_descriptor named(std::string_view new_name) const { return field_descriptor{new_name, attributes}; }
    ...
    {
        static_assert(has_attribute<A>(), "the field does not carry this attribute; check has_attribute<A>() first");
...
struct method_descriptor
{
    ...
    constexpr const A& attribute() const noexcept
    {
        static_assert(has_attribute<A>(), "the method does not carry this attribute; check has_attribute<A>() first");
        return std::get<detail::first_index_of<A, Attrs...>()>(attributes);
    }
